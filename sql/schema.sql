...
CREATE TABLE ingredients (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, meal_id INTEGER NOT NULL, food VARCHAR NOT NULL, amount INTEGER NOT NULL, UNIQUE(meal_id,food) );
